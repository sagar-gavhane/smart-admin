            ...
            <div class="col-xs-12 col-sm-12 padding-content">
                ...
                <div class="row">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?= base_url().'question_manager/update_question_form'; ?>"><i class="fa fa-pencil-square" aria-hidden="true"></i> Update Question</a></li>
                    </ol>
                </div>
                ...
                <div class="row">
                    <div class="page-heading">
                        <h2 class="page-heading__heading-text">Update Question</h2>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-4">
                        <div class="row">
                            <form id="create-question-form" action="<?= base_url().'question_manager/update_question/'.$questions_data[0]['question_id']; ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                                
                                <!-- question id -->
                                <input type="hidden" name="question_id" value="<?= $questions_data[0]['question_id']; ?>">
                                ...
                                <div class="form-group <?php if(strlen(form_error('question_title')) != 0) echo 'has-error'; ?>">
                                    ...
                                    <input type="text" class="form-control" name="question_title" value="<?= set_value('question_title', $questions_data[0]['question_title']) ?>" placeholder="Enter question title." minlength="6" maxlength="120" required>
                                ...
                                <div class="form-group <?php if(strlen(form_error('question_tags')) != 0) echo 'has-error'; ?>">
                                    ...
                                    <input type="text" class="form-control" name="question_tags" value="<?= set_value('question_tags', $questions_data[0]['question_title']) ?>" placeholder="Enter a question tags" maxlength="255" required>
                                ...
                                <div class="form-group <?php if(strlen(form_error('question_category')) != 0) echo 'has-error'; ?>">
                                    ...
                                    <input type="text" class="form-control" name="question_category" value="<?= set_value('question_category', $questions_data[0]['question_category']) ?>" placeholder="Enter a syllabus category." maxlength="255" required>
                                ...
                                */ ?>
                                ...
                                <div class="form-group <?php if(strlen(form_error('question_category')) != 0) echo 'has-error'; ?>">
                                    ...
                                    <select name="question_category" class="form-control" required>
                                        ...
                                        <?php foreach ($options as $key => $value): ?>
                                            <?php if(strtolower($value) == set_value('question_category', $questions_data[0]['question_category'])): ?>
                                ...
                                <div class="from-group">
                                    <button type="submit" class="btn btn-primary"><i class="fa fa-pencil-square" aria-hidden="true"></i> Update Question</button>
