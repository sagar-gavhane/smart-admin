            ...
            <div class="col-xs-12 col-sm-12 padding-content">
                ...
                <div class="row">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?= base_url().'syllabus_manager/update_syllabus_form/'. $syllabus_data[0]['syllabus_id']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Update Syllabus</a></li>
                    </ol>
                </div>
                ...
                <div class="row">
                    <div class="page-heading">
                        <h2 class="page-heading__heading-text">Update Syllabus</h2>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-4">
                        <div class="row">
                            <form id="update-syllabus-form" action="<?= base_url().'syllabus_manager/update_syllabus/'. $syllabus_data[0]['syllabus_id']; ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="form-group <?php if(strlen(form_error('syllabus_title')) != 0) echo 'has-error'; ?>">
                                    ...
                                    <input type="text" class="form-control" name="syllabus_title" value="<?= set_value('syllabus_title', $syllabus_data[0]['syllabus_title']) ?>" placeholder="Enter syllabus title." minlength="6" maxlength="120" required>
                                ...
                                <div class="form-group <?php if(strlen(form_error('syllabus_tags')) != 0) echo 'has-error'; ?>">
                                    ...
                                    <input type="text" class="form-control" name="syllabus_tags" value="<?= set_value('syllabus_tags', $syllabus_data[0]['syllabus_tags']) ?>" placeholder="Enter a syllabus tags" maxlength="255" required>
                                    <?php echo form_error('syllabus_tags', '<p class="text-danger">', '</p>'); ?>                                    
                                </div>

                                <!-- syllabus category -->
                                <?php /* <div class="form-group <?php if(strlen(form_error('syllabus_category')) != 0) echo 'has-error'; ?>">
                                    <label class="control-label label-required">Syllabus Category</label>
                                    <input type="text" class="form-control" name="syllabus_category" value="<?= set_value('syllabus_category', $syllabus_data[0]['syllabus_category']) ?>" placeholder="Enter a syllabus category." maxlength="255" required>
                                ...
                                */ ?>
                                ...
                                <div class="from-group">
                                    <button type="submit" class="btn btn-primary"><i class="fa fa-plus-square-o" aria-hidden="true"></i> Update Syllabus</button>
