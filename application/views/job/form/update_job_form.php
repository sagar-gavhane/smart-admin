            ...
            <div class="col-xs-12 col-sm-12 padding-content">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="<?= base_url().'job_manager/create_job_form/'; ?>">
                                <i class="fa fa-pencil-square-o"></i> Update Job
                            </a>
                        </li>
                    </ol>
                </div>
                ...
                <div class="row">
                    <div class="page-heading">
                        <h2 class="page-heading__heading-text">Update Job</h2>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-4">
                        <div class="row">
                            <form id="update-job-form" action="<?= base_url().'job_manager/update_job/'.$jobs_data[0]['job_id']; ?>" method="post" autocomplete="off" enctype="multipart/form-data">

                                <!-- job id -->
                                <input type="hidden" name="job_id" value="<?= $jobs_data[0]['job_id']; ?>">
                                ...
                                <div class="form-group <?php if(strlen(form_error('job_title')) != 0) echo 'has-error'; ?>">
                                    ...
                                    <input type="text" class="form-control" name="job_title" value="<?= set_value('job_title', $jobs_data[0]['job_title']) ?>" placeholder="Enter job title." minlength="6" maxlength="120" required>
                                ...
                                <div class="form-group <?php if(strlen(form_error('job_tags')) != 0) echo 'has-error'; ?>">
                                    ...
                                    <input type="text" class="form-control" name="job_tags" value="<?= set_value('job_tags', $jobs_data[0]['job_tags']) ?>" placeholder="Enter a job tags" maxlength="255" required>
                                ...
                                <div class="form-group <?php if(strlen(form_error('job_category')) != 0) echo 'has-error'; ?>">
                                    ...
                                    <input type="text" class="form-control" name="job_category" value="<?= set_value('job_category', $jobs_data[0]['job_category']) ?>" placeholder="Enter a syllabus category." maxlength="255" required>
                                ...
                                */ ?>
                                ...
                                <div class="form-group <?php if(strlen(form_error('job_category')) != 0) echo 'has-error'; ?>">
                                    ...
                                    <select name="job_category" class="form-control" required>
                                        ...
                                        <?php foreach ($options as $key => $value): ?>
                                            <?php if(strtolower($value) == set_value('job_category', $jobs_data[0]['job_category'])): ?>
                                ...
                                <div class="from-group">
                                    <button type="submit" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Update Job</button>
